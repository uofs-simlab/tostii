...
static const std::unordered_map<std::string, std::vector<OSpair<double>>>
    os_method{
        ...
        // {"Yoshida3",
        // std::vector<OSpair<double>>{
        //   OSpair<double>{2, y_omega[1] / 2.0},  //
        //   OSpair<double>{1, y_omega[1] / 2.0},  //
        //   OSpair<double>{0, y_omega[1]},  //
        //   OSpair<double>{1, y_omega[1] / 2.0},  //
        //   OSpair<double>{2, (y_omega[0] + y_omega[1]) / 2.0},  //
        //   OSpair<double>{1, y_omega[0] / 2.0},  //
        //   OSpair<double>{0, y_omega[0]},  //
        //   OSpair<double>{1, y_omega[0] / 2.0},  //
        //   OSpair<double>{2, (y_omega[0] + y_omega[1]) / 2.0},  //
        //   OSpair<double>{1, y_omega[1] / 2.0},  //
        //   OSpair<double>{0, y_omega[1]},  //
        ...
        std::vector<OSpair<double>>{
          OSpair<double>{0, y_omega[1] / 2.0},  //
          OSpair<double>{1, y_omega[1] / 2.0},  //
          OSpair<double>{2, y_omega[1]},  //
          OSpair<double>{1, y_omega[1] / 2.0},  //
          OSpair<double>{0, (y_omega[0] + y_omega[1]) / 2.0},  //
          OSpair<double>{1, y_omega[0] / 2.0},  //
          OSpair<double>{2, y_omega[0]},  //
          OSpair<double>{1, y_omega[0] / 2.0},  //
          OSpair<double>{0, (y_omega[0] + y_omega[1]) / 2.0},  //
          OSpair<double>{1, y_omega[1] / 2.0},  //
          OSpair<double>{2, y_omega[1]},  //
